...
{	return (int)(((flags>>plus)&1) - ((flags>>minus)&1));	}
...
extern IWRAM_CODE void memset32(void *dst, u32 wd, u32 wcount);
extern IWRAM_CODE void memcpy32(void *dst, const void* src, u32 wcount);
...
#define BFN_SET(y, x, name)		(y = (u16)(((u16)(y)&~name##_MASK) | (u16)BFN_PREP(x,name) ))
